            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <ul>
                        ...
                        <li class="list-unstyled"><a href="#">Advanced Search</a></li>
                        <li class="list-unstyled"><a href="#">Orders and Returns</a></li>
                        <li class="list-unstyled"><a href="contact.php">Contact Us</a></li>
                    </ul>
                </div>
                <div class="col-sm-3">
