...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $insertTutorName = $tutor->tutorInsert($tutorName);
    }
?>
    <div class="row my-5 ml-1">
        <div class="col-md-5 border border-dark" id="tutorAdd">
            <h1 class="my-5">Add New Tutor</h1>
            <?= isset($insertTutorName) ? $insertTutorName : "" ?>
            <form action="" method="post">
                <div class="form-group">
                    <input type="text" name="tutorName" placeholder="Tutor name" class="text-dark">
