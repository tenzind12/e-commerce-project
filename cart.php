...
require_once('./paypal/stripe-php/init.php');
?>
...
$session = \Stripe\Checkout\Session::create([
    ...
    'line_items' => [[
        'price_data' => [
            ...
            'unit_amount' => round($_SESSION['totalPrice'] * 100),
        ],
        'quantity' => 1,
    ]],
    'mode' => 'payment',
...
<div class="text-center row m-1 m-sm-5 d-flex flex-column">
    ...
    <div class="d-flex m-auto">
        ...
        ?>
            ...
            <div id="stripe-button">Checkout</div>
        <?php
        }
        ?>
    </div>
...
<!-- STRIPE SCRIPT TAG FRONT END -->
<script>
    const stripe = Stripe('pk_test_51KAuPUAKBlCe0kMM28dRBK87PLmH9wZicPdMZCAXopbyM4yRnhy4BTWOL4BdcXoCcHQGRtbc5OgYppgN5qaYo1IP00WXvCGocO');
